...
// we use a self executing anonymous function to be able to use variables in a closed scope
(function(){
	...
	PHYSIC.world.addContactMaterial(new CANNON.ContactMaterial(Character.MATERIAL, PHYSIC.world.defaultMaterial, {
		friction:    0,
		restitution: 0,
